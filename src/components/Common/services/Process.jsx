  ...
  return (
    <div className='w-full mt-12'>
      <div className='flex flex-col gap-2 sm:text-center xs:text-center xxs:text-center md:text-center lg:text-start xl:text-start 2xl:text-start w-full md:w-full sm:w-full xs:w-full xxs:w-full'>
            ...
            <h1 className='text-[28px] leading-10 text-dottedBorder sm:text-center xs:text-center xxs:text-center md:text-center lg:text-start xl:text-start 2xl:text-start  w-full font-bold'>{heading.toUpperCase()}</h1>
