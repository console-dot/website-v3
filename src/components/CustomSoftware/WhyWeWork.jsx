  ...
  return (
    <div className="">
      ...
      <div className="w-full flex justify-end pr-16">
        <div className="flex gap-8 w-[45%] mr-28 my-4 p-4 hover:border-2 hover:border-primaryText hover:border-dashed">
          <div>
      ...
      <div className="w-full flex justify-end pr-16">
        <div className="flex gap-8 w-[45%] p-4 hover:border-2 hover:border-primaryText hover:border-dashed">
          <div>
            <div className="w-[80px] h-[80px] bg-dottedBorder rounded-full flex items-center justify-center mb-4">
              <CloudCompIcon />
            </div>
