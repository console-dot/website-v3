  ...
  return (
    <div className="bg-white shadow-lg xl:w-full lg:w-full md:w-full xl:h-[460px] lg:h-[460px] md:h-[600px] h-[450px] rounded-lg xl:p-6 lg:px-1  lg:pb-6 md:px-6 md:pb-6 sm:px-6 sm:pb-6 xs:px-6 xs:pb-6 xss:px-6 xss:pb-6  flex-col hover:-translate-y-8 hover:border-dashed hover:border-2 hover:border-custom-blue1 w-full flex justify-center transition duration-300 ease-in-out mt-6 md:mb-0">
      ...
      <div className="w-full flex justify-center mt-6">
        <button className="xl:px-24 xl:py-2.5 lg:px-24 lg:py-1 md:px-24 md:py-2.5 sm:px-12 sm:py-2 xs:px-12 xs:py-2.5
        xss:px-12 xss:py-2.5 bg-custom-lightBlue text-custom-purple rounded-full focus:outline-none transition-colors duration-300 lg:hover:bg-gradient-to-tl lg:hover:from-custom-blue1 lg:hover:to-custom-purple lg:hover:text-custom-white lg:active:bg-gradient-to-r lg:active:from-custom-purple lg:active:to-custom-blue
